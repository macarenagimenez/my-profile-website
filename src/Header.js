  ...
  return (
    <div className="Header ">
      ...
      <div className="Description">
        ...
        <h2>About me</h2> <hr />
        <p>
          <FontAwesomeIcon icon={faGlasses} /> Here you’ll find a totaly nerd!!
          In constant capacitation to learn new and better tools for the
          technology and my new favorites lenguajes, english and french.
        </p>
        <p>
          <FontAwesomeIcon icon={faPersonThroughWindow} /> I’am a curious person
          and ready to get into the IT world, but no just that!, also I'am a
          passionate entrepreneur and a disapointed architect.
        </p>
        <p>
          <FontAwesomeIcon icon={faHand} /> I'm a creative, responsable and
          commited person. I like to work as a team and solve problems.
